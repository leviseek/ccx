...
- **v0.3.200（2026-08-28）**：M2 材料终版——**发起闭环入就绪页**；ctest 62/62 + node 121/121。
- **v0.3.199（2026-08-28）**：M2 发起终版——**注记 11（四线闭环）**；ctest 62/62 + node 121/121。
- **v0.3.198（2026-08-28）**：M1 收口 13——**申报页彩排 8 引用**；ctest 62/62 + node 121/121。
- **v0.3.197（2026-08-28）**：M2 彩排 8——**四线终态快照**；ctest 62/62 + node 121/121。
- **v0.3.196（2026-08-28）**：M2 终检 6——**ticket 四线终态**；ctest 62/62 + node 121/121。
- **v0.3.195（2026-08-28）**：M1 收口 12——**申报页四线终态引用**；ctest 62/62 + node 121/121。
- **v0.3.194（2026-08-28）**：M2 材料终版——**四线终态入就绪页**；ctest 62/62 + node 121/121。
- **v0.3.193（2026-08-28）**：M2 终检 5——**总纲发起终态记录**；ctest 62/62 + node 121/121。
- **v0.3.192（2026-08-28）**：M2 发起终版——**注记 10（彩排 7 + ticket 终态）**；ctest 62/62 + node 121/121。
- **v0.3.191（2026-08-28）**：M2 彩排 7——**终态快照含 ticket**；ctest 62/62 + node 121/121。
- **v0.3.190（2026-08-28）**：M2 材料终版——**ticket 终核入就绪页**；ctest 62/62 + node 121/121。
- **v0.3.189（2026-08-28）**：M1 收口 11——**W6 ticket 状态入申报**；ctest 62/62 + node 121/121。
- **v0.3.188（2026-08-28）**：M2 终检 4——**ticket 状态终核**（W6-1 🔄 壳工程开发中（五实证）；W6-2 ⏳ 待 macOS/Xcode）；ctest 62/62 + node 121/121。
- **v0.3.187（2026-08-28）**：M2 材料终版——**发起就绪终态入就绪页**；ctest 62/62 + node 121/121。
- **v0.3.186（2026-08-28）**：M2 发起终版——**注记 9（终检 3 全绿）**；ctest 62/62 + node 121/121。
- **v0.3.185（2026-08-28）**：M2 终检 3——**全链复核记录**（READY + verify 全绿）；ctest 62/62 + node 121/121。
- **v0.3.184（2026-08-28）**：M2 彩排 6——**终态快照记录**（数字一致/READY/设备全链）；ctest 62/62 + node 121/121。
- **v0.3.183（2026-08-28）**：M2 材料终版——**总纲 W6 行入列**（w6-release-chain）；ctest 62/62 + node 121/121。
- **v0.3.182（2026-08-28）**：M1 收口 10——**申报页数字终核（121/203/设备全链）**；ctest 62/62 + node 121/121。
- **v0.3.181（2026-08-28）**：M2 材料终版——**终检记录入就绪页**；ctest 62/62 + node 121/121。
- **v0.3.180（2026-08-28）**：M2 终检 2——**就绪页数字同步（62/121/203）+ 自检 READY 复核**；ctest 62/62 + node 121/121。
- **v0.3.179（2026-08-28）**：M2 发起终版——**注记 8（彩排 5 21.6s）**；ctest 62/62 + node 121/121。
- **v0.3.178（2026-08-28）**：M1 收口 9——**统计上报入申报**（W6 段补脚本驱动+统计上报）；ctest 62/62 + node 121/121。
- **v0.3.177（2026-08-28）**：M2 彩排 5——**全链含统计上报重演**（自检 18.9s/demo 2.6s/设备 stats 0.1s）；ctest 62/62 + node 121/121。
- **v0.3.176（2026-08-28）**：M2 发起终版——**发起文数字同步（121/W6 壳全链）**；ctest 62/62 + node 121/121。
- **v0.3.175（2026-08-28）**：M1 收口 8——**统计上报入快照 + 数字同步（121/203）**；ctest 62/62 + node 121/121。
- **v0.3.174（2026-08-28）**：M2 材料终版——**统计上报入评审包**；ctest 62/62 + node 121/121。
- **v0.3.173（2026-08-28）**：W6 上报面——**设备帧统计上报**（壳每 60 帧 logcat CCX_STATS（lastMs=0.2 实证）+ **ccx device stats**（拉取最新统计）——设备性能主机可见）；ctest 62/62 + node 121/121。
- **v0.3.172（2026-08-28）**：M2 发起终版——**发起文注记 6**（彩排 4：25.1s）；ctest 62/62 + node 120/120。
- **v0.3.171（2026-08-28）**：M2 彩排 4——**全链终态重演**（自检 19s/demo 2.6s/W1 2.7s/设备 0.8s ≈25.1s；仅 Actions 待 push）；ctest 62/62 + node 120/120。
- **v0.3.170（2026-08-28）**：M1 收口 7——**设备帧统计入快照**；ctest 62/62 + node 120/120。
- **v0.3.169（2026-08-28）**：M2 材料终版——**设备帧统计入评审包**（就绪页 W6 行）；ctest 62/62 + node 120/120。
- **v0.3.168（2026-08-28）**：W6 统计面——**设备帧统计**（nativeFrameStats：帧计数+最近帧耗时 ms，屏幕显示——设备上性能可见）；ctest 62/62 + node 120/120。
- **v0.3.167（2026-08-28）**：M2 发起终版——**发起文终态注记 5**（195 commits/壳全链/push 就绪）；ctest 62/62 + node 120/120。
- **v0.3.166（2026-08-28）**：push 终核 3——**清单终态记录**（树干净/195 commits/GPU+设备双就绪——push 就绪终态）；ctest 62/62 + node 120/120。
- **v0.3.165（2026-08-28）**：M1 收口 6——**W6 脚本驱动入快照**；ctest 62/62 + node 120/120。
- **v0.3.164（2026-08-28）**：M2 材料终版——**脚本驱动入评审包**（就绪页 W6 行：QuickJS 脚本驱动场景）；ctest 62/62 + node 120/120。
...
- **v0.3.158（2026-08-28）**：M1 收口 4——**W6 成果入申报**（环境绑定项收敛：GPU+设备 ✅，仅 Actions/签名待办）；ctest 62/62 + node 120/120。
- **v0.3.157（2026-08-28）**：M2 材料终版——**W6 全链入评审**（就绪页/发起声明：壳 App 运行/帧循环/引擎光栅上屏；缺口仅签名发布）；ctest 62/62 + node 120/120。
...
- **v0.3.150（2026-08-28）**：W6 环境 100%——**gradle 9.7.1 就绪**（手动经代理下载（scoop 下载器不走代理，与 adb 同因）；发布链环境全齐：SDK+NDK+CMake+Java+gradle+设备——缺口仅 JNI 壳工程）；ctest 62/62 + node 119/119。
- **v0.3.149（2026-08-28）**：W6 发布链评估——**环境侧 90% 就绪**（SDK 完整（build-tools/platforms/licenses）+ NDK + CMake + Java17 + 设备；缺口仅 gradle 与 JNI 壳工程——样例链可排期，w6-release-chain.md 记录）；ctest 62/62 + node 119/119。
...
- **v0.3.133（2026-08-28）**：W1×W7 变体——**骨骼帧 GPU 数据面**（spine_dump --wgpu：骨骼帧经 WgpuDevice 上传/读回 → PPM；CLI 冒烟测试（P6 头/尺寸）；路径 JSON 规整）；ctest 62/62 + node 116/116。
...
- **v0.3.128（2026-08-28）**：M2 评审终版——**17 步入评审文档**（就绪页/发起声明/快照数字同步：61/115/197/17 步）；ctest 61/61 + node 115/115。
- **v0.3.127（2026-08-28）**：demo 十七步——**spine.frame 骨骼帧步入交付链**（ccx_spine_dump 工具 + 双骨骼 JSON 片段 → 渲染项 → PPM；嵌套 spawn stdout 混入字节 → 正则容错抽取）；ctest 61/61 + node 115/115。
- **v0.3.126（2026-08-28）**：M2 发起面——**评审正式发起（终态声明）**（m2-review-launch.md：就绪终态全绿复核（61/114/16/12 张 ✅/门禁）+ 发起条件 + 待环境项如实）；就绪页数字刷新；ctest 61/61 + node 114/114。
- **v0.3.125（2026-08-28）**：W1×W7 合流——**骨骼动画渲染项 → 真 GPU 帧**（e2e.spine_gpu：Spine JSON → 采样 → RenderItem → 软件光栅黄金帧 → WgpuDevice 上传/读回 → 像素一致 + 骨骼位置像素在场；0.55s 一次通过）；ctest 61/61 + node 114/114。
- **v0.3.124（2026-08-28）**：M2 终核面——**T-W7-1 ✅ 已验收**（凭据：spine 3 测试+W1 渲染路径；m2-tickets 仅剩 W6 待环境）、**评审发起终核注记**（GPU ✅/首批 11+W7 ✅/就绪 READY）；ctest 60/60 + node 114/114。
...
- **v0.3.105（2026-08-28）**：M2 发起面——**评审发起文**（m2-review-invitation.md：邀请/20 分钟议程/会前准备（自检 READY）/预期产出（三择+批次决议+签字）——发起评审的最后一块）；ctest 51/51 + node 109/109。
- **v0.3.104（2026-08-28）**：M1 交接面——**交接终检**（m1-handoff 终检版：CLI 命令数刷新 27+、与申报一致性注记、数字指向 summary）；ctest 51/51 + node 109/109。
- **v0.3.103（2026-08-28）**：M2 校验面——**材料包闭环校验**（总纲 20 件 ↔ 自检 16 md + 4 mjs + 3 命令：自检全覆盖，一致性结论固化入总纲）；ctest 51/51 + node 109/109。
- **v0.3.102（2026-08-28）**：M1 申报面——**里程碑完结申报**（m1-completion.md：9 判据逐条核对（8 ✅ + 环境 ⏳ 如实）+ 终态数字（51/109/15/185）+ 申报路径——M1 从"可评审"到"可申报完结"）；ctest 51/51 + node 109/109。
- **v0.3.101（2026-08-28）**：M2 自检全面化——**材料自检扩至 16 件**（总纲四组全量；含 m2-kickoff/m1-handoff/gate-review 等）、**就绪页补门禁行**（layered 76 + vendor 5）；ctest 51/51 + node 109/109。
- **v0.3.100（2026-08-28）**：M1 终检终版——**带双门禁全量一次过**（ctest 51 + node 108 + layered 76 文件 + vendor 5 包）；**门禁纳入每轮全量流程**（固化缺失教训）；summary 固化门禁行 + 数字（108/184）；ctest 51/51 + node 108/108。
- **v0.3.99（2026-08-28）**：M1 门禁面——**layered_imports 模块登记补齐**（assets/game/particle/script 目录名 + scene→physics 集成白名单；76 文件合规）、**M2 完结签**（m2-tickets 验收记录补签核栏）、终检终版（ctest 51 + node 108 + 双门禁全绿）；ctest 51/51 + node 108/108。
- **v0.3.98（2026-08-28）**：M2 材料面——**立项材料包总纲**（m2-package-index.md：四组 20 件材料树状索引 + 生成方式（⚙ 自动/人工）+ 使用路径——评审会外一站式自取）；ctest 51/51 + node 108/108。
- **v0.3.97（2026-08-28）**：W2 页面面——**预览 undo 会话栏**（preview 页内联 __HISTORY（可回退步数/当前实体/回退后实体）+ 回退按钮（静态快照语义说明）；测试断言 3 项）；ctest 51/51 + node 108/108。
- **v0.3.96（2026-08-28）**：M1 终核面——**双链终核**（117 commits/21 文档/14 模块/32 测试文件，树干净）、**验收记录入档**（m2-tickets 复核 9/9 + 批次决议）、能力清单补预算入口；ctest 51/51 + node 107/107。
- **v0.3.95（2026-08-28）**：W2 交互面——**预览会话回退**（ccx editor preview --apply ... --undo/--redo：生成前会话内回退；applied 流程留痕（create_entity→undo 断言）；途中修正误挂分支（scene apply vs preview））；ctest 51/51 + node 107/107。
