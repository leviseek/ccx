...
- CTest 51/51；node --test 100/100；引擎构建模块 14；Node 测试文件 27；demo all **15 步**全 ok
- 守护合计 ≈ 175 项；vendor 包 5（pal/audio/storage/main/quickjs）
...
| 脚本 | `ccx script run`（--engine 走 QuickJS） |
