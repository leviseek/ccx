...
writeFileSync(join(site, 'index.html'), [
  ...
  '</style></head><body>',
  '<script>if (location.protocol === "file:") { document.body.innerHTML = "<div style=\'font:16px monospace;padding:30px;color:#ffd75e;background:#0b0c1a\'>请通过本地服务打开（勿双击 file://）：<br>node ccx.mjs serve --watch<br>然后访问 http://127.0.0.1:8321/</div>"; }</script>',
  '<div id="ccx-sub">时间采掘公司第一章 · 遗迹采掘（残影 = 过去的你）</div>',
  '<div id="ccx-error" class="hidden" style="font:13px monospace;color:#ff8a8a;background:rgba(40,10,10,.9);border:1px solid #e05252;border-radius:4px;padding:6px 12px;margin:8px 0;max-width:900px;word-break:break-all;"></div>',
  '<div id="ccx-start" style="border:1px solid #33365a;border-radius:10px;background:#12142a;padding:18px 28px;margin:10px 0;text-align:center;box-shadow:0 0 30px rgba(76,191,168,.15);">',
  '<div style="font-size:26px;letter-spacing:4px;color:#e8e8ff;">时之三重奏</div>',
  '<div style="color:#9fe2d0;font-size:13px;margin:8px 0 14px;">R 录制过去的你 · E 召唤残影 · Q 与残影换位——破解时间机关，收集时之碎片</div>',
  '<div style="margin-bottom:12px;"><select id="ccx-level" style="font:14px monospace;padding:6px 10px;background:#13223a;color:#e8e8ff;border:1px solid #4cbfa8;border-radius:4px;"></select> <button id="ccx-start-btn" style="font:15px monospace;padding:8px 26px;border:1px solid #4cbfa8;background:#1d3a52;color:#9fe2d0;border-radius:6px;cursor:pointer;">开始游戏</button></div>',
  '<div style="color:#7f88b8;font-size:12px;">←→/AD 移动 · 空格 跳跃 · R 录制 · E 召唤 · Q 换位 · P 暂停 · 目标石碑（绿）为终点</div>',
  '</div>',
