...
export interface Sfx {
  jump(): void; collect(): void; door(): void; summon(): void;
  swap(): void; deny(): void; win(): void;
}
export interface AudioEngine { sfx: Sfx; resume(): void }
...
export function createAudio(): AudioEngine {
  ...
  function tone(freq: number, dur: number, type: OscillatorType = 'square', vol = 0.07, slide = 0, delay = 0): void {
